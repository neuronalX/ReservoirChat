...
temperatures = [0.1]
model_url = 'http://localhost:8000/v1/chat/completions'  # Replace with the correct endpoint for Codestral
model_name = 'TechxGenus/Codestral-22B-v0.1-GPTQ'  # Ensure this is the correct model name
api_key = 'EMPTY'  # Replace with your actual API key

for questions_file in input_files:
    for temp in temperatures:
        output_file = f"question_and_test_{questions_file.split('/')[-1].replace('.md', '')}_{temp}.txt"
